...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDependencyResolvers(new ICoreModule[] { //COREMODULE GÝBÝ OLUÞTURUP BURAYA EKLEYEBÝLÝRÝZ
            new CoreModule()
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseAuthentication();//MÝDDLEWEAR DENÝYOR HANGÝ YAPILARIN SIRASI ÝLE DEVREYE GÝRECEÐÝMÝZÝ SÖYLÜYRUZ.
